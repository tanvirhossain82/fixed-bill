...
export const STRINGS = {
  ...
  tabNmLedger: { bn: '৪. Nippon–Modhumoti হিসাব লেজার', en: '4. Nippon–Modhumoti Account Ledger' },
  ...
  nmTypePurchase: { bn: 'ক্রয় (Modhumoti থেকে — পাওনা বাড়বে)', en: 'Purchase (from Modhumoti — increases payable)' },
  nmTypePayment: { bn: 'পেমেন্ট (Modhumoti-কে — পাওনা কমবে)', en: 'Payment (to Modhumoti — decreases payable)' },
  ...
  nmLedgerTitle: { bn: 'Nippon Paint — Modhumoti সিএনজি পাম্প হিসাব', en: 'Nippon Paint — Modhumoti CNG Pump Account' },
  nmLedgerHint: {
    bn: 'প্রতিটি এন্ট্রি সংরক্ষিত হয় এবং পাতা রিলোড করলেও থেকে যাবে। জমা (ক্রয়) কলামে যা Modhumoti-কে দিতে হবে তা যোগ হয়, পরিশোধ কলামে যা দেওয়া হয়েছে তা বিয়োগ হয়। "অটো" চিহ্নিত এন্ট্রি ক্রয় এন্ট্রি বা বিল পেমেন্ট থেকে স্বয়ংক্রিয়ভাবে তৈরি হয়েছে।',
    en: 'Each entry is saved and persists across page reloads. The Purchase column adds what is owed to Modhumoti; the Payment column subtracts what has been paid. Entries marked "Auto" are generated automatically from purchase entries or bill payments.',
  },
  ...
  nmDescPurchase: { bn: 'ক্রয় — Modhumoti থেকে জ্বালানি', en: 'Purchase — fuel from Modhumoti' },
  nmDescPayment: { bn: 'পেমেন্ট — Modhumoti-কে প্রদান', en: 'Payment — paid to Modhumoti' },
  autoTag: { bn: 'অটো', en: 'Auto' },
  emptyNm: {
    bn: 'এখনো কোনো হিসাব এন্ট্রি যোগ করা হয়নি। উপরের ফর্ম থেকে শুরু করুন।',
    en: 'No ledger entries yet. Start with the form above.',
  },
  nmOutstanding: { bn: 'Modhumoti-কে বর্তমান পাওনা (Outstanding Balance)', en: 'Outstanding Balance (payable to Modhumoti)' },
