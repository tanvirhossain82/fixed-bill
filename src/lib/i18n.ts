...
export const STRINGS = {
  ...
  nmStmtMonth: { bn: 'মাস', en: 'Month' },
  nmStmtFrom: { bn: 'শুরুর তারিখ', en: 'From Date' },
  nmStmtTo: { bn: 'শেষের তারিখ', en: 'To Date' },
  nmStmtClear: { bn: 'সব দেখান', en: 'Show All' },
  nmPrintPdf: { bn: 'প্রিন্ট / PDF', en: 'Print / PDF' },
  stmtTitle: { bn: 'স্টেশন হিসাব বিবরণী', en: 'Station Account Statement' },
  stmtPeriod: { bn: 'সময়কাল', en: 'Period' },
  stmtAllTime: { bn: 'সর্বমোট (সব সময়)', en: 'All time' },
  stmtOpeningBal: { bn: 'প্রারম্ভিক জের', en: 'Opening Balance' },
  stmtClosingBal: { bn: 'সমাপনী জের', en: 'Closing Balance' },
  stmtStation: { bn: 'ফিলিং স্টেশন', en: 'Filling Station' },
  stmtGeneratedOn: { bn: 'তৈরির তারিখ', en: 'Generated on' },
